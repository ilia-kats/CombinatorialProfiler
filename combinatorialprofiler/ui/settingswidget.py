...
class SettingsWidget(QWidget):
    ...
    def serialize(self):
        return {"insert_mismatches" : self.ui.mismatches.value(), "barcode_length" : self.ui.barcodeLength.value(), "barcode_mismatches" : round(self.ui.barcodeMismatches.value(), 3)}
